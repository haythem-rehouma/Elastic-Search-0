...
> **Pré-requis** : [Setup A à Z](./00-setup-complet-a-z.md) + [Solutions chap. 14](./solutions-14-bulk-import.md) (l'index `news` doit contenir 200 853 articles).
...
→ Si ces requêtes vous parlent, vous êtes prêt pour le [chapitre 16](../../16-requetes-avancees-kql-esql-dsl.md) (KQL vs ES|QL vs DSL) et le [Labo 2](./solutions-17-labo2.md).
