...
> **Pré-requis** : [Setup A à Z](./00-setup-complet-a-z.md) + [Solutions chap. 14](./solutions-14-bulk-import.md) (index `news` chargé).
...
> **Recommandation pour le Labo 2** ([chapitre 17](./solutions-17-labo2.md)) : on utilise **uniquement le DSL** pour bien le maîtriser.
