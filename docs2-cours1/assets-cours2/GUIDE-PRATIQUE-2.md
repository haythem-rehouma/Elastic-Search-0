...
flowchart TB
    ...
    A -.utilise.-> P14[Projet ch14-bulk-import]
    B -.utilise.-> P15[Projet ch15-requetes]
    B -.utilise.-> P16[Projet ch16-kql-esql-dsl]
    C -.utilise.-> P17[Projet ch17-labo2]
```
...
[`solutions/ch14-bulk-import/`](./solutions/ch14-bulk-import/) — voir son [README](./solutions/ch14-bulk-import/README.md).

### Marche à suivre (1 commande)

```bash
cd docs2-cours1/assets-cours2/solutions/ch14-bulk-import
...
Vous devez voir : `"count": 200853`. Si non → voir [Cas d'erreurs](./solutions/ch14-bulk-import/README.md#) ou la FAQ ci-dessous.
...
> **Documentation détaillée :** [chapitre 14](../14-import-bulk-dataset.md) et [`solutions-14-bulk-import.md`](./solutions/solutions-14-bulk-import.md).
...
| Projet                                          | Couvre                                       |
| ----------------------------------------------- | -------------------------------------------- |
| [`ch15-requetes/`](./solutions/ch15-requetes/)  | Toutes les requêtes DSL intermédiaires       |
| [`ch16-kql-esql-dsl/`](./solutions/ch16-kql-esql-dsl/) | KQL vs ES\|QL vs DSL côte-à-côte         |

### Marche à suivre

1. Garder la stack ch14 démarrée (l'index `news` y est déjà chargé).
2. Ouvrir Kibana → Dev Tools → Console.
3. Coller le snippet [`ch15-requetes/console/all-queries.txt`](./solutions/ch15-requetes/console/all-queries.txt) — **16 requêtes commentées** prêtes à exécuter.
...
| -------------------------------------------------------------------------- | ------------------------ |
| [`console/01-kql-discover.txt`](./solutions/ch16-kql-esql-dsl/console/01-kql-discover.txt) | Barre de recherche **Discover** |
| [`console/02-esql-devtools.txt`](./solutions/ch16-kql-esql-dsl/console/02-esql-devtools.txt) | **Dev Tools** → `POST _query` |
| [`console/03-dsl-devtools.txt`](./solutions/ch16-kql-esql-dsl/console/03-dsl-devtools.txt)   | **Dev Tools** → `GET news/_search` |
...
- [Chapitre 15 — Requêtes intermédiaires](../15-requetes-elasticsearch-intermediaire.md) + [`solutions-15`](./solutions/solutions-15-requetes-intermediaires.md)
- [Chapitre 16 — KQL/ES\|QL/DSL](../16-requetes-avancees-kql-esql-dsl.md) + [`solutions-16`](./solutions/solutions-16-kql-esql-dsl.md)
...
[`solutions/ch17-labo2/`](./solutions/ch17-labo2/) — voir son [README](./solutions/ch17-labo2/README.md).

### Marche à suivre (2 commandes)

```bash
cd docs2-cours1/assets-cours2/solutions/ch17-labo2
...
Un **template prérempli** est fourni : [`solutions/ch17-labo2/docs/rapport-template.md`](./solutions/ch17-labo2/docs/rapport-template.md).
...
Vous tentez de modifier un mapping après création (interdit). Solution : créer un **nouvel index** + `_reindex` depuis l'ancien. Voir requête #16 dans `ch15-requetes/console/all-queries.txt`.
